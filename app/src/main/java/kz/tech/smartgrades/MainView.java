...
public class MainView extends DrawerLayout {
    ...
    public MainView(@NonNull Context context) {
        ...
        dlMain = this;
        this.setLayoutParams(new DrawerLayoutParams().getParams(context, PARAMS));
        this.setFitsSystemWindows(true);

        flContainer = new CustomFrameLayout().onCustom(context, PARAMS_CONTAINER);
        this.addView(flContainer);

        //          MAIN CONTAINER          //
        flMain = new FrameLayout(context);
        params = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, FrameLayout.LayoutParams.MATCH_PARENT);
        params.gravity = Gravity.CENTER_VERTICAL|Gravity.CENTER_HORIZONTAL;
        params.setMargins(0, DimensionDP.sizeDP(50, context), 0, DimensionDP.sizeDP(50, context));
        flMain.setLayoutParams(params);
        flContainer.addView(flMain);
        flMain.setId(VarID.ID_FL_MAIN);

        progressBar = new CustomProgressBar().onCustom(context, PARAM_LOAD_ANIMATION);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            progressBar.setElevation(DimensionDP.sizeDP(10,context));
        }
    ...
    private void initToolbar() {
        ...
        ivLeftButton = new CustomImageView().onCustom(context, PARAM_LEFT_BUTTON, 0);
        ...
        ivLogo = new CustomImageView().onCustom(context, PARAM_LOGO, R.drawable.logo);
    ...
    public void setAvatar(String image) {
        Picasso.get().load(image).fit().centerInside().error(R.mipmap.avatar).placeholder(R.mipmap.avatar).into(civAvatar);
    }
    ...
    private void initBottomNavigationView() {
        ...
        params.height = DimensionDP.sizeDP(50, context);
    ...
    private void initFragmentViewPager() {
        ...
        viewPager = new CustomViewPager().onCustom(context, PARAM_VIEW_PAGER);
    ...
    private void initChildViewPager() {
        rlViewPager = new CustomRelativeLayout().onCustom(context, PARAM_RL_VIEW_PAGER);
        flMain.addView(rlViewPager);

        childViewPager = new CustomViewPager().onCustom(context, PARAM_CHILD_VIEW_PAGER);
        rlViewPager.addView(childViewPager);
        adapter = new PagerAdapterPhotoChild(context);
        ...
        ivLeftArrow = new CustomImageView().onCustom(context, PARAM_VIEW_PAGER_LEFT, R.mipmap.red_left);
        ...
        ivRightArrow = new CustomImageView().onCustom(context, PARAM_VIEW_PAGER_RIGHT, R.mipmap.red_right);
