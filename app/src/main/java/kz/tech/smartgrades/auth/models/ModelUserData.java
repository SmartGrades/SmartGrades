...
public class ModelUserData implements Parcelable {
    ...
    public ModelUserData(String Avatar, String Birthday, String FirstName, String LastName, String UserId, String Login, String Phone, String Type, String Code, String Password) {
        this.Avatar = Avatar;
    ...
    protected ModelUserData(Parcel in) {
    ...
    public static final Creator<ModelUserData> CREATOR = new Creator<ModelUserData>() {
        @Override
        public ModelUserData createFromParcel(Parcel in) {
            return new ModelUserData(in);
        }

        @Override
        public ModelUserData[] newArray(int size) {
            return new ModelUserData[size];
        }
    };
