...
public class MultiChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ArrayList<ModelDefaultChat> multiTypeArrayList;
    ...
    public int getItemViewType(int position) {
        ...
        ModelDefaultChat m = multiTypeArrayList.get(position);
    ...
    public void updateList(ArrayList<ModelDefaultChat> arrayList) {
        onClear();
