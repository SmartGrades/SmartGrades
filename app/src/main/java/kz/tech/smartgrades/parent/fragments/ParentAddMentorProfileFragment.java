...
import static kz.tech.smartgrades._Web.func_ChildAddMentor;
...
public class ParentAddMentorProfileFragment extends Fragment implements View.OnClickListener{
    ...
    private void addMentor() {
        ...
        jsonObject.addProperty(F.MentorId, mMentor.getId());

        String SOAP = SoapRequest(func_ChildAddMentor, jsonObject.toString());
    ...
    public void setMentorModel2(ModelMentorList mMentor, String lessonId, String parentId, String childId) {
