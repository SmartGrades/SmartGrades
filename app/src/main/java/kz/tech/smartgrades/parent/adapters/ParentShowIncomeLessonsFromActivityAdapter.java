...
public class ParentShowIncomeLessonsFromActivityAdapter extends FragmentPagerAdapter {
    ...
    public ParentShowIncomeLessonsFromActivityAdapter(FragmentManager fm) {
        super(fm);
    ...
    public void setLessonsWithSmartGradesData(ModelLessonsWithSmartGrades mLessonsWithSmartGrades) {
        if (parentChildLessonInfoFragment != null) {
            parentChildLessonInfoFragment.setLessonsWithSmartGradesData(mLessonsWithSmartGrades);
        }
    }
