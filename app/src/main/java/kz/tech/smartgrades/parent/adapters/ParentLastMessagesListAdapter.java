...
public class ParentLastMessagesListAdapter extends RecyclerView.Adapter<ParentLastMessagesListAdapter.ViewHolder> {
    ...
    public ParentLastMessagesListAdapter(ParentActivity activity) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ParentLastMessagesListAdapter.ViewHolder holder, int position) {
