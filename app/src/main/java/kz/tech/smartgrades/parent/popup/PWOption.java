...
public class PWOption extends PopupWindow implements View.OnClickListener, ParentLessonOptionsAdapter.OnItemClickListener{
    ...
    public PWOption(int width, int height, ParentActivity activity, ArrayList<ModelMentorList> mentors, String lessonName, String lessonId) {
        super(width, height);
