...
public class ParentExtractCardListAdapter extends RecyclerView.Adapter<ParentExtractCardListAdapter.ViewHolder> {

    private ParentActivity activity;
    private ArrayList<ModelUserCards> cardList;

    private OnItemCLickListener onItemCLickListener;

    public interface OnItemCLickListener {
        void onExtractClick(ModelUserCards mCard);
        void onOptionClick(ModelUserCards mCard, View itemView);
    }
    public void setOnItemCLickListener(OnItemCLickListener onItemCLickListener) {
        this.onItemCLickListener = onItemCLickListener;
    }

    public ParentExtractCardListAdapter(ParentActivity activity) {
    ...
    public void updateData(ArrayList<ModelUserCards> childList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position){
        ModelUserCards m = cardList.get(position);
        holder.ivExtract.setRotation(180);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(@NonNull View itemView) {
            ...
            tvExtract.setText(activity.getResources().getString(R.string.withdraw));
            ...
            ivExtract.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View view){
                    ...
                    onItemCLickListener.onExtractClick(cardList.get(getAdapterPosition()));
                }
            });
