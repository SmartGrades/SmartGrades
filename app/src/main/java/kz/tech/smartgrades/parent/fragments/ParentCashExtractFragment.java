...
import kz.tech.smartgrades.parent.adapters.ParentExtractCardListAdapter;
import kz.tech.smartgrades.parent.bottom_sheet_dialogs.BSDRenameCard;
import kz.tech.smartgrades.parent.bottom_sheet_dialogs.ParentBSDExtract;
...
public class ParentCashExtractFragment extends Fragment implements View.OnClickListener, ParentExtractCardListAdapter.OnItemCLickListener{
    public static final String ARG_PAGE = "ARG_PAGE";
    private String PARENT_ID;
    private int mPage;
    private ParentExtractCardListAdapter adapter;
    private ParentActivity activity;
    private RecyclerView rvBankCards;
    private TextView tvAddNewCard;
    private ArrayList<ModelDiscontCard> cards;

    public ParentCashExtractFragment(ParentActivity activity, int i){
    ...
    private void initViews(View view){
        ...
        adapter = new ParentExtractCardListAdapter(activity);
    ...
    public void onExtractClick(ModelDiscontCard mCard) {
        ParentBSDExtract dialog = new ParentBSDExtract(activity, mCard);
        dialog.show();
    }
