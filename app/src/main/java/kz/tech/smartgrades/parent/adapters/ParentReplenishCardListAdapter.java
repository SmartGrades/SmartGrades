...
public class ParentReplenishCardListAdapter extends RecyclerView.Adapter<ParentReplenishCardListAdapter.ViewHolder> {
    ...
    public interface OnItemCLickListener {
        void onReplenishClick(ModelUserCards mCard);
    ...
    public ParentReplenishCardListAdapter(ParentActivity activity) {
