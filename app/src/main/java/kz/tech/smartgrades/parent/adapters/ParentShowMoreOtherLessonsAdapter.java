...
public class ParentShowMoreOtherLessonsAdapter extends FragmentPagerAdapter {

    private ArrayList<Fragment> fragmentArrayList = new ArrayList<>();

    private ParentAllOtherLessonFragment parentAllOtherLessonFragment;
    ...
    public ParentShowMoreOtherLessonsAdapter(FragmentManager fm) {
        super(fm);
        parentAllOtherLessonFragment = new ParentAllOtherLessonFragment();
        ...
        fragmentArrayList.add(parentAllOtherLessonFragment);
    ...
    public void setLessonList(ArrayList<ModelLessonsWithOutSmartGrades> lessonsWithOutSmartGrades) {
        parentAllOtherLessonFragment.setLessonList(lessonsWithOutSmartGrades);
    }
    ...
    public void setLessonsWithOutSmartGradesData(ModelLessonsWithOutSmartGrades mLessonsWithOutSmartGrades) {
        if (parentChildLessonInfoFragment != null) {
            parentChildLessonInfoFragment.setLessonsWithOutSmartGradesData(mLessonsWithOutSmartGrades);
        }
    }
    ...
    public void loadMentorList(String lessonId) {
        parentAddMentorListFragment.loadMentorList(lessonId);
    }

    public void setMentorModel2(kz.tech.smartgrades.mentor.models.ModelMentorList mMentor, String lessonId, String parentId, String childId) {
        parentAddMentorProfileFragment.setMentorModel2(mMentor, lessonId, parentId, childId);
    }
