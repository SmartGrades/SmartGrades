...
public class ParentChildSmartLessonInfoFragmentFFFFFFFFF extends Fragment implements View.OnClickListener {
    ...
    private void onOptionsClick() {
        ...
        PWOption popupWindow = new PWOption(width, height, activity, mLessonsWithSmartGrades.getMentors(), mLessonsWithSmartGrades.getLessonName(), mLessonsWithSmartGrades.getChildLessonId());
