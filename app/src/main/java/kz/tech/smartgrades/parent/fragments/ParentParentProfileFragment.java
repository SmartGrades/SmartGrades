...
public class ParentParentProfileFragment extends Fragment implements View.OnClickListener {
    ...
    private ModelParentInFamilyGroup mParent;
    ...
    public void setParentModel(ModelParentInFamilyGroup mChild) {
        this.mParent = mChild;
        setTargetInfo();
    }
    ...
    private void onAddParent() {
        ...
        jsonData.addProperty(F.TargetParentId, mParent.getUserId());
