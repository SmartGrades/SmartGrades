...
public class ParentAddParentListAdapter extends RecyclerView.Adapter<ParentAddParentListAdapter.ViewHolder> {
    ...
    public interface OnItemCLickListener {
        void onClick(ModelParentInFamilyGroup mParent);
    }
    ...
    public void updateData(ArrayList<ModelParentInFamilyGroup> parentList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position){
        ModelParentInFamilyGroup m = parentList.get(position);
        ...
        ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View view){
                    ...
                    onItemCLickListener.onClick(parentList.get(getAdapterPosition()));
                }
            });
        }
    }
