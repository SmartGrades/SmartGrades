...
import kz.tech.smartgrades.parent.adapters.ParentTransactionsByMonthListAdapter;
...
public class ParentTransactionFragment extends Fragment implements View.OnClickListener{
    ...
    private ParentTransactionsByMonthListAdapter parentTransactionsByMonthListAdapter;

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        activity = (ParentActivity) getActivity();
        mParent = activity.getMParentData();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState){
        ...
        initViews(view);
        loadTransactionData(PARENT_ID);
        if (!stringIsNullOrEmpty(mParent.getPrivateAccount().getCurrentSum())) {
            if (Integer.parseInt(mParent.getPrivateAccount().getCurrentSum()) > 0)
                tvMyReward.setText("+" + mParent.getPrivateAccount().getCurrentSum());
            else tvMyReward.setText(mParent.getPrivateAccount().getCurrentSum());
    ...
    private void initViews(View view){
        ...
        tvMyRewardLabel.setText(R.string.Family_group_balance);
    ...
    private void setTransactionList() {
        ...
        parentTransactionsByMonthListAdapter = new ParentTransactionsByMonthListAdapter(activity);
        rvIncomeHistoryByDate.setAdapter(parentTransactionsByMonthListAdapter);
        parentTransactionsByMonthListAdapter.updateData(mTransactionsMonthList);
