...
public class ParentGradesTableFragment extends Fragment implements View.OnClickListener, DefaultChatAdapter.OnItemClickListener {
                    ...
                    activity.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if (result.equals("0")) {
                                ...
                                Type founderListType = new TypeToken<ArrayList<ModelDefaultChat>>(){}.getType();
                        ...
                        public void onFocusChange(View view, boolean hasFocus) {
                            if (hasFocus) {
                                if (Index[0] != -1) {
                                    ...
                                    int i = Convert.S2I(etMoneyNumb[Index[0]].getText().toString());
                                    if (i < 0)
                    ...
                    etMoneyNumb[0].setOnKeyListener(new View.OnKeyListener() {
                        ...
                        public boolean onKey(View v, int keyCode, KeyEvent event) {
                            ...
                            if (event.getAction() == KeyEvent.ACTION_UP) {
                                int totalSum = Convert.S2I(etMoneyNumb[0].getText().toString()) + Convert.S2I(etMoneyNumb[1].getText().toString()) + Convert.S2I(etMoneyNumb[2].getText().toString()) + Convert.S2I(etMoneyNumb[3].getText().toString());
                            ...
                            activity.runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    if (result.equals("0")) activity.alert.onToast("Ошибка, попробуйте позже");
                                        ...
                                        Type founderListType = new TypeToken<ArrayList<ModelDefaultChat>>() {}.getType();
                                        ArrayList<ModelDefaultChat> mChatMessages = new Gson().fromJson(result, founderListType);
