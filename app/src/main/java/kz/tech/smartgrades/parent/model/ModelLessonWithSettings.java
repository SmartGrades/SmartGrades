...
public class ModelLessonWithSettings implements Parcelable {
    ...
    public ModelLessonWithSettings() {
    }

    protected ModelLessonWithSettings(Parcel in) {
    ...
    public static final Creator<ModelLessonWithSettings> CREATOR = new Creator<ModelLessonWithSettings>() {
        @Override
        public ModelLessonWithSettings createFromParcel(Parcel in) {
            return new ModelLessonWithSettings(in);
        }

        @Override
        public ModelLessonWithSettings[] newArray(int size) {
            return new ModelLessonWithSettings[size];
        }
    };
