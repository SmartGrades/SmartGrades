...
public class ParentAllTransactionFragment extends Fragment implements View.OnClickListener{
    ...
    private void initViews(View view){
        ...
        tvMyRewardLabel.setText(R.string.child_balance);
    ...
    public void setChildModel(ModelChildData mChild) {
        loadTransactionData(mChild.getId());
