...
public class ParentChildSchoolListAdapter extends RecyclerView.Adapter<ParentChildSchoolListAdapter.ViewHolder> {

    private ParentActivity activity;
    private ArrayList<ModelSchoolList> schoolList;

    public ParentChildSchoolListAdapter(ParentActivity activity) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ParentChildSchoolListAdapter.ViewHolder holder, int position) {
