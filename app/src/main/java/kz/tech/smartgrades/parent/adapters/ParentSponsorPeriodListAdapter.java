...
public class ParentSponsorPeriodListAdapter extends RecyclerView.Adapter<ParentSponsorPeriodListAdapter.ViewHolder> {

    private ParentActivity activity;
    private ArrayList<ModelChildPeriods> modelPeriod;
    private ModelChildSponsorship modelChildSponsorship;
    ...
    public ParentSponsorPeriodListAdapter(ParentActivity activity, ModelChildSponsorship modelChildSponsorship) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ParentSponsorPeriodListAdapter.ViewHolder holder, int position) {
