...
public class ParentChatAddMentorFragment extends Fragment implements View.OnClickListener {
    ...
    private DefaultChatAdapter defaultChatAdapter;
    ...
    private void initViews(View view) {
        ...
        defaultChatAdapter = new DefaultChatAdapter(activity, activity.login.loadUserDate(LoginKey.ID));
    ...
    public void setWardData(ModelMentorSponsorRoom value) {
        mentorModel = value;
        Picasso.get().load(mentorModel.getAvatar()).fit().centerInside().into(civAvatar);
