...
public class SponsorEditProfileFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.nav_dialog_edt_prrofile_child, container, false);
    }
    @Override
    ...
    private void onButtonSendIsReady() {
        btnSend.setBackgroundResource(isAboutMe ? R.drawable.btn_background_purple :
                R.drawable.btn_background_purple_alpha);
        btnSend.setEnabled(isAboutMe);
    }
    ...
    private void onSendClick() {
        activity.presenter.onAddAboutMe(etAboutMe.getText().toString());
    }
