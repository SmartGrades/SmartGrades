...
public class ModelInterFormSponsorToParent {
    ...
    public ModelInterFormSponsorToParent() { }

    public ModelInterFormSponsorToParent(ArrayList<ModelMentorChat> childList, String idGroup, String name) {
    }
