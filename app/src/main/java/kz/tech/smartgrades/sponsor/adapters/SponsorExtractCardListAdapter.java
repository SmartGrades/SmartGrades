...
public class SponsorExtractCardListAdapter extends RecyclerView.Adapter<SponsorExtractCardListAdapter.ViewHolder> {
    ...
    public interface OnItemCLickListener {
        void onExtractClick(ModelDiscontCard mCard);
    ...
    public SponsorExtractCardListAdapter(SponsorActivity activity) {
