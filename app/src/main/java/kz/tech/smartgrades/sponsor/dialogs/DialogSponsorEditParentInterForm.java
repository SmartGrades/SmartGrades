...
public class DialogSponsorEditParentInterForm extends Dialog implements View.OnClickListener {
    ...
    public interface OnItemClickListener {
        void onItemClick(ArrayList<ModelDefaultChat> modelChats);
    }
                    ...
                    activity.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if (result.equals("0")) { }
                                ...
                                if (avatar != null && !avatar.isEmpty()) Picasso.get().load(avatar).fit().centerInside().into(civChildAvatar);
                                ...
                                if (avatar != null && !avatar.isEmpty()) Picasso.get().load(avatar).fit().centerInside().into(civParentAvatar);
