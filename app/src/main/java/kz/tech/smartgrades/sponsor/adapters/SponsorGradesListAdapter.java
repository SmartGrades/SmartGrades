...
public class SponsorGradesListAdapter extends RecyclerView.Adapter<SponsorGradesListAdapter.ViewHolder> {
    ...
    public SponsorGradesListAdapter(SponsorActivity activity) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SponsorGradesListAdapter.ViewHolder holder, int position) {
