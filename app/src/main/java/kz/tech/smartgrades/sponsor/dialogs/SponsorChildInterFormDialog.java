...
import kz.tech.smartgrades.sponsor.models.ModelInterFormSponsorToParent;
...
public class SponsorChildInterFormDialog extends Dialog implements View.OnClickListener {
    ...
    private ModelInterFormSponsorToParent mInterForm;
    ...
    public interface OnItemClickListener {
        void onItemClick(ModelInterFormSponsorToParent modelChats);
    }
    ...
    private void setChildData() {
        ...
        tvChildLogin.setText(mChild.getFirstName() + " " + mChild.getLastName());
    }
    ...
    private void LessonSelectClick(int number) {
        ...
        if(!listIsNullOrEmpty(mChild.getLessons())){
            ...
            LessonsListAdapter.setOnItemClickListener(new GetChildLessonsListAdapter.OnItemClickListener() {
                @Override
                public void onItemClick(ModelLessonsForSponsorship m){
            ...
            tvListCleanLabel.setText("Список предметов пуст");
        }
    }
    ...
    private void onBtnSaveClick(){
        ...
        mInterForm = new ModelInterFormSponsorToParent();
        mInterForm.setSourceId(SPONSOR_ID);
        mInterForm.setSponsorId(SPONSOR_ID);
        mInterForm.setChildId(mChild.getUserId());
        mInterForm.setParentId(mChild.getParentId());
        if(LessonSelected[0]!=null) mInterForm.setLessonId1(LessonSelected[0].getChildLessonId());
        if(LessonSelected[1]!=null) mInterForm.setLessonId2(LessonSelected[1].getChildLessonId());
        if(LessonSelected[2]!=null) mInterForm.setLessonId3(LessonSelected[2].getChildLessonId());
        if(LessonSelected[3]!=null) mInterForm.setLessonId4(LessonSelected[3].getChildLessonId());
