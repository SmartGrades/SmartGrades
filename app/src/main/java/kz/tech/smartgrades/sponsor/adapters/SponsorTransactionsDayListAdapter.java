...
public class SponsorTransactionsDayListAdapter extends RecyclerView.Adapter<SponsorTransactionsDayListAdapter.ViewHolder> {
    ...
    public SponsorTransactionsDayListAdapter(SponsorActivity activity) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SponsorTransactionsDayListAdapter.ViewHolder holder, int position) {
