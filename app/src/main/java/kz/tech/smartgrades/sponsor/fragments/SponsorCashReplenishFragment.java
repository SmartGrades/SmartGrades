...
import kz.tech.smartgrades.sponsor.bottom_sheet_dialog.SponsorBSDReplenish;
...
public class SponsorCashReplenishFragment extends Fragment implements View.OnClickListener, SponsorReplenishCardListAdapter.OnItemCLickListener{
    ...
    public SponsorCashReplenishFragment(SponsorActivity activity, int i){
    ...
    @Override
    public void onReplenishClick(ModelDiscontCard mCard) {
        SponsorBSDReplenish dialog = new SponsorBSDReplenish(activity, mCard);
        dialog.show();
    }
