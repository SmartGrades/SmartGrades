...
public class SponsoredHistoryListAdapter extends RecyclerView.Adapter<SponsoredHistoryListAdapter.ViewHolder> {
    ...
    public SponsoredHistoryListAdapter(ParentActivity activity) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SponsoredHistoryListAdapter.ViewHolder holder, int position) {
