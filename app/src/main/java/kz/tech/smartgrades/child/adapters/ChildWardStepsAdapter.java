...
public class ChildWardStepsAdapter extends RecyclerView.Adapter<ChildWardStepsAdapter.ViewHolder> {
    ...
    private ArrayList<ModelDefaultChat> arrayMultiType;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Picasso.get().load(arrayList.get(position).getAvatar()).fit().centerInside().into(holder.civStepAvatar);
        Picasso.get().load(arrayList.get(position).getChildAvatar()).fit().centerInside().into(holder.civChildAvatar);

        int getDone = Convert.S2I(arrayList.get(position).getDone());
        int getTotal = Convert.S2I(arrayList.get(position).getCount());
    ...
    public void updateGroup(ArrayList<ModelInteractionToolSteps> arrayListe, ArrayList<ModelDefaultChat> modelDefaultChat) {
        //onClear();
