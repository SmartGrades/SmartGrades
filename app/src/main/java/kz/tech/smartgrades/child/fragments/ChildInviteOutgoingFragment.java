...
public class ChildInviteOutgoingFragment extends Fragment implements ChildInviteListAdapter.OnItemClickListener{
    ...
    public ChildInviteOutgoingFragment(ChildActivity activity, int i){
