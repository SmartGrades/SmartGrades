...
public class ChildSponsorPeriodListAdapter extends RecyclerView.Adapter<ChildSponsorPeriodListAdapter.ViewHolder> {
    ...
    public ChildSponsorPeriodListAdapter(ChildActivity activity, ModelChildSponsorship modelChildSponsorship) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ChildSponsorPeriodListAdapter.ViewHolder holder, int position) {
