...
public class ChildUsersListAdapter extends RecyclerView.Adapter<ChildUsersListAdapter.ViewHolder> {
    ...
    private ArrayList<ModelDefaultChat> arrayList;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Picasso.get().load(arrayList.get(position).getSourceAvatar()).fit().centerInside().into(holder.civAvatar);
    }
    ...
    public void updateData(ArrayList<ModelDefaultChat> arrayListe) {
