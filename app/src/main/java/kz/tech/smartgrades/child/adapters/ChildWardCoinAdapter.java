...
public class ChildWardCoinAdapter extends RecyclerView.Adapter<ChildWardCoinAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        int coinsCount = Convert.S2I(arrayList.get(position).getValue());
    ...
    public void updateGroup(ArrayList<ModelChildWardCoin> arrayListe, ArrayList<ModelDefaultChat> modelDefaultChat) {
        //onClear();
