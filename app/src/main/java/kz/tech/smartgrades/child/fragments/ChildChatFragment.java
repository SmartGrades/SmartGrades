...
import kz.tech.smartgrades.child.adapters.ChildChatAdapter;
...
public class ChildChatFragment extends Fragment implements View.OnClickListener,
        ChildChatAdapter.OnItemCLickListener,
    ...
    private void onLoadChatMessages(String lessonId) {
        ...
        json.addProperty(F.UserId, CHILD_ID);
    ...
    private void setMessages(ArrayList<ModelChatMessages> modelChatMessagesList) {
        ...
        childChatAdapter = new ChildChatAdapter(activity);
        childChatAdapter.setOnItemClickListener(this);
        rvMessages.setAdapter(childChatAdapter);
        childChatAdapter.updateData(modelChatMessagesList);
        rvMessages.scrollToPosition(childChatAdapter.getItemCount() - 1);
    }
