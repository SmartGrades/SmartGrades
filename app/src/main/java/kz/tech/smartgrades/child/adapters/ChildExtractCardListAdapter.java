...
public class ChildExtractCardListAdapter extends RecyclerView.Adapter<ChildExtractCardListAdapter.ViewHolder> {
    ...
    public ChildExtractCardListAdapter(ChildActivity activity) {
