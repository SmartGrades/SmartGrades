...
public class ModelChildData implements Parcelable{
    ...
    public ModelChildSponsorship Sponsorship;
    ...
    protected ModelChildData(Parcel in){
        ...
        Sponsorship = in.readParcelable(ModelChildSponsorship.class.getClassLoader());
        Id = in.readString();
    ...
    public ModelChildSponsorship getSponsorship(){
        return Sponsorship;
    }
    public void setSponsorship(ModelChildSponsorship sponsorship){
