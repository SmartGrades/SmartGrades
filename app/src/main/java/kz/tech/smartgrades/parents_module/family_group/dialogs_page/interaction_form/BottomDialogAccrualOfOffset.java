...
public class BottomDialogAccrualOfOffset extends BottomSheetDialog {
    ...
    public BottomDialogAccrualOfOffset(Context context, Resources res, String s1, String s2) {
        super(context);
        ...
        TextView tvName = new CustomTextView().onCustom(context, PARAM_TITLE, res.getString(R.string.accrual_of_offset_title));
    ...
    public BottomDialogAccrualOfOffset(@NonNull Context context, int theme) {
        super(context, theme);
    }

    protected BottomDialogAccrualOfOffset(@NonNull Context context, boolean cancelable, OnCancelListener cancelListener) {
