...
public class BottomDialogAccrualOfCoinsSuper extends BottomSheetDialog {
    ...
    private String lol = "+7";
    public BottomDialogAccrualOfCoinsSuper(Context context, Resources res, String text) {
        super(context);
