package kz.tech.smartgrades.parents_module.auto_charge.models;
...
public class ModelAutoCharge {
    ...
    @Nullable
    @SerializedName("hTimeAutoCharge")
    @Expose
    private String hTimeAutoCharge;
    @Nullable
    @SerializedName("zSwitch")
    @Expose
    private String zSwitch;

    public ModelAutoCharge() {}


    public ModelAutoCharge(@Nullable String aMonday, @Nullable String bTuesday, @Nullable String cWednesday,
                           @Nullable String dThursday, @Nullable String eFriday, @Nullable String fSaturday,
                           @Nullable String gSunday, @Nullable String hTimeAutoCharge, @Nullable String zSwitch) {
        ...
        this.hTimeAutoCharge = hTimeAutoCharge;
    ...
    @Nullable
    public String gethTimeAutoCharge() {
        return hTimeAutoCharge;
    }

    public void sethTimeAutoCharge(@Nullable String hTimeAutoCharge) {
        this.hTimeAutoCharge = hTimeAutoCharge;
    }
