...
public class AutoChargeAdapter extends RecyclerView.Adapter<AutoChargeAdapter.ViewHolder> {
    private OnItemClickListener onItemClickListener;
    public interface OnItemClickListener {
        void onItemClick(int position, String time);
        void onCoinsCheckedOffClick(int position, String coins);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (arrayList.get(position) != null) {
            ...
            if (arrayList.get(position).equals("close")) {
                ...
                int lol = Integer.parseInt(arrayList.get(position));
                int first = lol / 20;
                holder.tvTime.setText(String.valueOf(first) + " = " +arrayList.get(position));
            }
        ...
        ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    int position = getAdapterPosition();
                    if (onItemClickListener != null) {
                        onItemClickListener.onCoinsCheckedOffClick(position, arrayList.get(position));
                    }
                    return false;
                }
            });
    ...
    public void setData(ModelAutoCharge data) {
        arrayList.clear();
        if (data != null) {
