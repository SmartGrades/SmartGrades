...
public class ParentAddChildActivity extends AppCompatActivity implements IView, View.OnClickListener {
    ...
    public void onNextFragment(ModelUserData m) {
    ...
    public void setChildAvatar(String avatarSelectChild) {
        presenter.setChildAvatar(avatarSelectChild);
    }
    public void setChildAvatarOriginal(String avatarSelectChild) {
        presenter.setChildAvatarOriginal(avatarSelectChild);
    }
    ...
    public void setChildMail(String Mail) {
        presenter.setChildPhoneOrMail(Mail);
    }
    public void setChildPhone(String Phone) {
        presenter.setChildPhoneOrMail(Phone);
    }
