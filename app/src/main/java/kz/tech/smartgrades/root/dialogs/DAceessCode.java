...
public class DAceessCode extends Dialog implements View.OnClickListener{
    ...
    public DAceessCode(AppCompatActivity activity, String type, ModelUserData userData){
        ...
        if(type.equals(SPONSOR)) sponsorActivity = (SponsorActivity) activity;
                        ...
                        activity.runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                if (result.equals("0")) {
                                    ...
                                    ivDot1[0].setBackground(activity.getResources().getDrawable(R.drawable.view_oval_rectangle_dots_active));
                                    ivDot1[1].setBackground(activity.getResources().getDrawable(R.drawable.view_oval_rectangle_dots_active));
                                    ivDot1[2].setBackground(activity.getResources().getDrawable(R.drawable.view_oval_rectangle_dots_active));
                                    ivDot1[3].setBackground(activity.getResources().getDrawable(R.drawable.view_oval_rectangle_dots_active));
                                }
                                else {
                                    dismiss();
