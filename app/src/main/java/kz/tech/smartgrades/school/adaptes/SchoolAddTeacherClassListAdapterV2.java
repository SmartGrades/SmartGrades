...
public class SchoolAddTeacherClassListAdapterV2 extends RecyclerView.Adapter<SchoolAddTeacherClassListAdapterV2.ViewHolder>{
    ...
    public SchoolAddTeacherClassListAdapterV2(){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType){
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_class_list_v2, parent, false));
    }
    @Override
