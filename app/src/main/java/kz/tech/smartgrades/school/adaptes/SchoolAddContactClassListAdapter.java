...
public class SchoolAddContactClassListAdapter extends RecyclerView.Adapter<SchoolAddContactClassListAdapter.ViewHolder>{
    ...
    public SchoolAddContactClassListAdapter(){
