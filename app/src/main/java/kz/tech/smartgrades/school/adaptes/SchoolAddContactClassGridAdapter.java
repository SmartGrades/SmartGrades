...
public class SchoolAddContactClassGridAdapter extends RecyclerView.Adapter<SchoolAddContactClassGridAdapter.ViewHolder>{
    ...
    public SchoolAddContactClassGridAdapter(Context context){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType){
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_school_class_grid, parent, false));
    }
    @Override
