...
public class SchoolEditProfileFragment extends Fragment implements View.OnClickListener {
    ...
    private void onSendClick() {
        //activity.presenter.onAddWorksheet(etAboutMe.getText().toString(), etKeyWordsYourMentors.getText().toString());
    }
    ...
    private void UpdateAvatar(){
        if (SelectAvatar != null){
            ...
            SelectAvatar.compress(Bitmap.CompressFormat.PNG, 25, outputStream);
