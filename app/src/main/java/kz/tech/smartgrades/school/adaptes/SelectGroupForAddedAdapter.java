...
public class SelectGroupForAddedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SelectGroupForAddedAdapter(Context context) {
    ...
    @NonNull
    @Override
    public SelectGroupForAddedAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
