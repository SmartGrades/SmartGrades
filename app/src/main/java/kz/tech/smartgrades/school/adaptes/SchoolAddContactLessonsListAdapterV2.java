...
public class SchoolAddContactLessonsListAdapterV2 extends RecyclerView.Adapter<SchoolAddContactLessonsListAdapterV2.ViewHolder>{
    ...
    public SchoolAddContactLessonsListAdapterV2(){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType){
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_lessons_list_v2, parent, false));
    }
    @Override
