    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (m.getGrades().size() > 2){
            ...
            if (m.getGrades().size() == 1){
                ...
                if (m.getGrades().get(0).getGrade().equals("5")) holder.tvGrade1.setBackground(context.getResources().getDrawable(R.drawable.background_square_purple));
                else if (m.getGrades().get(0).getGrade().equals("4")) holder.tvGrade1.setBackground(context.getResources().getDrawable(R.drawable.background_square_green));
                else if (m.getGrades().get(0).getGrade().equals("3")) holder.tvGrade1.setBackground(context.getResources().getDrawable(R.drawable.background_square_orange));
                else if (m.getGrades().get(0).getGrade().equals("2")) holder.tvGrade1.setBackground(context.getResources().getDrawable(R.drawable.background_square_red));
            }
            else{
                holder.tvGrade1.setVisibility(View.VISIBLE);
                holder.tvGrade1.setText(m.getGrades().get(0).getGrade());
                ...
                if (m.getGrades().get(0).getGrade().equals("5")) holder.tvGrade2.setBackground(context.getResources().getDrawable(R.drawable.background_square_purple));
                else if (m.getGrades().get(0).getGrade().equals("4")) holder.tvGrade2.setBackground(context.getResources().getDrawable(R.drawable.background_square_green));
                else if (m.getGrades().get(0).getGrade().equals("3")) holder.tvGrade2.setBackground(context.getResources().getDrawable(R.drawable.background_square_orange));
                else if (m.getGrades().get(0).getGrade().equals("2")) holder.tvGrade2.setBackground(context.getResources().getDrawable(R.drawable.background_square_red));
            }
        }
    }
