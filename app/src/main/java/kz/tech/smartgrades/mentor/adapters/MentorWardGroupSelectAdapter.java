...
public class MentorWardGroupSelectAdapter extends RecyclerView.Adapter<MentorWardGroupSelectAdapter.ViewHolder> {
    ...
    public MentorWardGroupSelectAdapter(Context context) {
