...
import kz.tech.smartgrades.mentor.models.ModelChildrens;
...
public class DialogMentorAddChild extends Dialog implements View.OnClickListener{
    ...
    public DialogMentorAddChild(@NonNull MentorActivity activity, ModelUserData mChild){
