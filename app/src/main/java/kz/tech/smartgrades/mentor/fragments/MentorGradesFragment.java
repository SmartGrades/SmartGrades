...
public class MentorGradesFragment extends Fragment implements View.OnClickListener, DefaultChatAdapter.OnItemClickListener, GradesTableMonthAdapter.OnItemClickListener {
    ...
    public static MentorGradesFragment newInstance(ModelMentorChat modelMentorChat, ModelMentorGroups modelMentorGroup) {
        Bundle bundle = new Bundle();
        bundle.putParcelable("mChildrenList", modelMentorChat);
        bundle.putParcelable("mMentorGroup", modelMentorGroup);
        MentorGradesFragment fragment = new MentorGradesFragment();
