...
public class MentorAddStudentClassListAdapter extends RecyclerView.Adapter<MentorAddStudentClassListAdapter.ViewHolder>{

    private ArrayList<ModelMentorClass> ClassList;

    public interface OnItemCLickListener{
        void onClassClick(ModelMentorClass m);
    }
    ...
    public MentorAddStudentClassListAdapter(){
    ...
    public void UpdateData(ArrayList<ModelMentorClass> ClassList){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position){
        ModelMentorClass m = ClassList.get(position);
