...
public class QuickAccessSignInView extends FrameLayout {
    ...
    public QuickAccessSignInView(Context context, Resources res) {
        super(context);
    ...
    public QuickAccessSignInView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public QuickAccessSignInView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public QuickAccessSignInView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
